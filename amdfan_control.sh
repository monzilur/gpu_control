curl -k https://example.com/script.sh > /home/miner/userstartupscript.sh && sh /home/miner/userstartupscript.sh
	
#while sleep 1; do echo 0 > /sys/class/drm/card0/device/hwmon/hwmon1/pwm1_enable; done
